const games = [
  {
    ...
    description:
      'Help your bug family claim the best real estate in a spilled can of beans. Info from repo.',
    price: 35,
    rating: Math.random(),
  },
  {
    ...
    description: 'A circular game of Chess that you can eat as you play. Info from repo.',
    price: 15,
    rating: Math.random(),
  },
  {
    ...
    description: 'A cat grooming contest goes horribly wrong. Info from repo.',
    price: 45,
    rating: Math.random(),
  },
];
